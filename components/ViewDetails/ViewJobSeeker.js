      ...
      <View style={styles.userContainer}>
        ...
        <HStack>
          <Text style={styles.nameText}>
            {details.firstname?.length > 0 && details.firstname}{" "}
          </Text>
          <Text style={styles.nameText}>
            {details.lastname?.length > 0 && details.lastname}
          </Text>
        </HStack>
        <Text style={styles.emailText}>
          {viewUser.email?.length > 0 && viewUser.email}
        </Text>
        <View style={styles.education}>
          <Text style={styles.Phone}>Phone</Text>
          <Text style={styles.PhoneActual}>{details.phone}</Text>
          <Text style={styles.Phone}>Skills</Text>
          <Text style={styles.PhoneActual}>{details.skills}</Text>
          <Text style={styles.Phone}>About</Text>
          <Text style={styles.PhoneActual}>{details.about}</Text>
          <Text style={styles.Phone}>Prefrences</Text>
          {/* <HStack style={{ justifyContent: "space-evenly" }}> */}
          <Text style={styles.PhoneActualLan}>Languages</Text>
          <Text style={styles.PhoneActualFooter}>
            {viewUser.Languages.split("\n").join(" - ")}
          </Text>
          <Text style={styles.PhoneActualLan}>Job Titles</Text>
          <Text style={styles.PhoneActualFooter}>
            {viewUser.search.split("\n").join(" - ")}
          </Text>
          {/* </HStack> */}
        </View>
      </View>
